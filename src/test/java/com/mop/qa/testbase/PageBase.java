...
public class PageBase extends TestBase {
	...
	public void validateVideo(WebElement ele, String fileLocation, String className) throws Exception {
		Thread.sleep(1000);
		String file1 = elementScreenshot(ele, fileLocation, className);
		Thread.sleep(3000);
		String file2 = elementScreenshot(ele, fileLocation, className);
		processImage(file1, file2);
	}
	...
	public String elementScreenshot(WebElement ele, String fileLocation, String className) throws IOException {
		...
		BufferedImage eleScreenshot = fullImg.getSubimage(ele.getLocation().getX(), ele.getLocation().getY(), eleWidth, eleHeight);
	...
	public void processImage(String file1, String file2) throws Exception {
		try {
			...
			test.log(LogStatus.INFO, "Image1:"+test.addScreenCapture(file1));
			test.log(LogStatus.INFO, "Image2:"+test.addScreenCapture(file1));
			if (result == false) {
				test.log(LogStatus.PASS, "Result = Video is playing - PASS ");
				test.log(LogStatus.PASS, "Video Playing--Image 1",test.addScreenCapture(file1));
				test.log(LogStatus.PASS, "Video Playing--Image 2",test.addScreenCapture(file2));
				test.log(LogStatus.PASS, "Result = Video is playing - PASS ");
				//rg.passTestCase("Result = Video is playing - PASS ");
			} else {
				test.log(LogStatus.PASS, "Result = Video is not playing - PASS ");
				//rg.logException("Result = Video is not Playing - FALSE" + null, null);
				test.log(LogStatus.PASS, "Video is not Playing - FALSE-Image 1",test.addScreenCapture(file1));
				test.log(LogStatus.PASS, "Video is not Playing - FALSE--Image 2",test.addScreenCapture(file2));
			}
	...
	public void selectOPtion(String xpath, String text) throws InterruptedException {
		Thread.sleep(3000);
