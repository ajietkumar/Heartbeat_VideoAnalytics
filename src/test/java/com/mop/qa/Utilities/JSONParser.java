...
public class JSONParser extends PageBase {
	...
	public static HashMap<String, Object> getTKXValues(String url) throws Exception {
	//	String Response = SendGetPost.sendPost("http://tkx-prod.nbc.anvato.net/rest/v2/tve/?anvack=XE5XpDni9xLBF6C02OBLFLb3vRhlP5zz");
	...
	public static HashMap<String, String> feedResponse() throws Exception {
		String Response = SendGetPost.sendGet("http://feed.theplatform.com/f/HNK2IC/bravo_cpc_iOS_v4_prd?byGUID=3534572");
		System.out.println(Response);
		ObjectMapper objectMapper = new ObjectMapper();
		Map<String, Object> featureEnabled;
		Map<String, Object> map = new HashMap<String, Object>();
